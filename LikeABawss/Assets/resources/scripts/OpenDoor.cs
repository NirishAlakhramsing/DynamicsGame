...
public class OpenDoor : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        if (col.gameObject.tag == "Player")
        {
            ...
            {
                iTween.MoveAdd(moveColliderBox = GameObject.Find("CloseDoorFirstEnemy"), iTween.Hash("amount", new Vector3(0, 0, stepziseCollisionBox1), "time", 0.5f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none));
                stepziseCollisionBox1 = 1 * -stepziseCollisionBox1;

                iTween.MoveAdd(GameObject.Find("FirstEnemyDoor"), iTween.Hash("amount", new Vector3(0, stepsizeEnemyDoor1, 0), "time", 2.5f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none));
            ...
            {
                iTween.MoveAdd(moveColliderBox = GameObject.Find("CollisionBoxKey1"), iTween.Hash("amount", new Vector3(stepziseCollisionBoxKey1, 0, 0), "time", 0.5f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none));
                stepziseCollisionBoxKey1 = 1 * -stepziseCollisionBoxKey1;

                iTween.MoveAdd(GameObject.Find("DoorKeyOne"), iTween.Hash("amount", new Vector3(0, stepsizeKeyDoor1, 0), "time", 2.5f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none));
